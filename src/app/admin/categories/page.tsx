...
export default function AdminCategoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Kategori Yönetimi</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <form onSubmit={editingCategory ? handleUpdateCategory : handleAddCategory} className="space-y-4">
          ...
          <div>
            <label htmlFor="slug" className="block text-sm font-medium text-gray-700">Slug (URL Dostu İsim)</label>
            <input
              type="text"
              id="slug"
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Mevcut Kategoriler</h2>
        {categories.length === 0 ? (
