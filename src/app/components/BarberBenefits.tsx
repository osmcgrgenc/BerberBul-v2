  ...
  const benefits = [
    {
      ...
      description:
        "Geniş müşteri tabanımıza ulaşarak işinizi büyütün ve yeni müşteriler kazanın.",
    ...
    },
    {
      ...
      title: "Kolay Yönetim",
      description:
        "Randevularınızı, hizmetlerinizi ve müşteri bilgilerinizi tek bir yerden yönetin.",
    ...
    },
    {
      ...
      description:
        "Dijital varlığınızı güçlendirin ve online platformlarda öne çıkın.",
    ...
    },
    {
      ...
      title: "Akıllı Takvim",
      description:
        "Otomatik randevu sistemi ile müşteri taleplerini kolayca yönetin.",
    ...
    },
    {
      ...
      title: "Güvenli Ödeme",
      description:
        "Müşteri ödemelerini güvenli bir şekilde alın ve finansal takibinizi yapın.",
    ...
    },
    {
      ...
      description:
        "İş performansınızı takip edin ve gelişim alanlarınızı belirleyin.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            İşinizi dijitalleştirin, müşteri sayınızı artırın ve gelirlerinizi
            yükseltin. Modern berberlik işletmesi için gerekli tüm araçlar
            burada.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-2 bg-indigo-50 text-indigo-700 px-6 py-3 rounded-full">
            ...
            <span className="font-medium">
              Berber işletmenizi dijitalleştirmek için hemen kayıt olun!
            </span>
          </div>
        </div>
      </div>
